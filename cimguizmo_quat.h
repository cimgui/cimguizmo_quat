...
CIMGUI_API bool iggizmo3Dvec3PtrFloat(const char* noname1,G3Dvec3* noname2,float noname3,const int noname4);
CIMGUI_API bool iggizmo3DquatPtrquatPtr(const char* noname1,quat* noname2,quat* noname3,float noname4,const int noname5);
CIMGUI_API bool iggizmo3DquatPtrvec4Ptr(const char* noname1,quat* noname2,G3Dvec4* noname3,float noname4,const int noname5);
CIMGUI_API bool iggizmo3DquatPtrvec3Ptr(const char* noname1,quat* noname2,G3Dvec3* noname3,float noname4,const int noname5);
CIMGUI_API bool iggizmo3Dvec3PtrquatPtrFloat(const char* noname1,G3Dvec3* noname2,quat* noname3,float noname4,const int noname5);
CIMGUI_API bool iggizmo3Dvec3Ptrvec4Ptr(const char* noname1,G3Dvec3* noname2,G3Dvec4* noname3,float noname4,const int noname5);
CIMGUI_API bool iggizmo3Dvec3Ptrvec3Ptr(const char* noname1,G3Dvec3* noname2,G3Dvec3* noname3,float noname4,const int noname5);
